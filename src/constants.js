...
export const TARGET_FOOD = 2000, MAX_FOOD = 3000;
...
export const LS_GAMES_PLAYED_KEY = 'neon-serpent-games-played';
export const LS_TOTAL_KILLS_KEY = 'neon-serpent-total-kills';
